...
# 데이터 경로 설정
train_dir = "/content/Fake_Face_Classification_Min-jeong-LEE/archive/train/"  # 훈련 데이터 경로
val_dir = "/content/Fake_Face_Classification_Min-jeong-LEE/archive/Validation" # 검증 데이터 경로 (optional)
